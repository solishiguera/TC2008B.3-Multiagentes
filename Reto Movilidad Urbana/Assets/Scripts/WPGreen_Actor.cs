...
public class WPGreen_Actor : MonoBehaviour
{
     float speed = 5.0f;
    float timetoWait;
    bool advance = true;
        ...
        if(advance){
            ...
            if(passed){
                ...
                if(timetoWait < -3 && timetoWait > -4){
                    GameObject.Find ("Semaforo3").GetComponent<Renderer>().material = yellow;
                    advance = true;
            ...
            if(timetoWait < 0 && timetoWait > -3){
                ...
                GameObject.Find ("Semaforo3").GetComponent<Renderer>().material = green;
                passed = true;
                advance = true;
            }
        }
