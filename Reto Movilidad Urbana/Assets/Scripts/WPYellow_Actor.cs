...
public class WPYellow_Actor : MonoBehaviour
{
    float speed = 5.0f;
        ...
        if(advance){
            ...
            if(passed){
                ...
                if(timetoWait < -3 && timetoWait > -4){
                    GameObject.Find ("Semaforo1").GetComponent<Renderer>().material = yellow;
                    advance = true;
            ...
            if(timetoWait < 0 && timetoWait > -3){
                ...
                GameObject.Find ("Semaforo1").GetComponent<Renderer>().material = green;
                passed = true;
                advance = true;
            }
        }
